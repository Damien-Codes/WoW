class Weapon:
    ...
    def damage(self, new_damage):
        if isinstance(new_damage, (int, float)) and new_damage >= 0:
            ...
            print(f"Error : The damage must be a positive number !")
            self._damage = 10
    ...
    def length(self, new_length):
        if isinstance(new_length, (int, float)) and new_length > 0:
            ...
            print(f"Error : The length must be a positive number !")
            self._length = 50
    ...
    def weight(self, new_weight):
        if isinstance(new_weight, (int, float)) and new_weight > 0:
            ...
            print(f"Error : The weight must be a positive number !")
            self._weight = 5
    ...
    def health(self, new_health):
        if isinstance(new_health, (int, float)) and new_health >= 0:
            ...
            print(f"Error : The health must be a positive number !")
            self._health = 100